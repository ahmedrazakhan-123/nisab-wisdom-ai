...
const ZakatCalculator: React.FC = () => {
  ...
  const silverPricePerGram = SILVER_PRICE_PER_GRAM;
    ...
    <div className="mt-4 p-4 border rounded-lg bg-background/50 animate-fade-in-up w-full">
      ...
      {calculation && (
       ...
       <p className="text-xs text-muted-foreground mt-4">
        Note: This calculator uses fixed estimated prices for gold (${goldPricePerGram.toFixed(2)}/g) and silver (${silverPricePerGram.toFixed(2)}/g). This is for informational purposes. For an accurate calculation, please consult a qualified scholar.
      </p>
    </div>
  );
};
