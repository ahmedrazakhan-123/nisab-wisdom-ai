  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-cream dark:bg-background">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 max-w-6xl">
        ...
        <h1 
          className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 text-brand-teal dark:text-brand-teal-light leading-tight animate-fade-in-up"
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <Button 
            asChild 
            size="lg" 
            className="cta-button magnetic-hover bg-brand-teal hover:bg-brand-teal/90 text-white px-16 py-6 text-xl rounded-2xl shadow-2xl group relative overflow-hidden"
          >
            <Link to="/zakat-calculator" onClick={() => trackEvent({ name: 'calculate_zakat', props: { location: 'hero' } })}>
              ...
              <Calculator className="mr-3 h-6 w-6 relative z-10 transition-transform duration-300 group-hover:scale-110" />
          ...
          <Button 
            ...
            variant="outline" 
            size="lg" 
            className="magnetic-hover border-2 border-brand-teal text-brand-teal hover:bg-brand-teal hover:text-white px-12 py-6 text-lg rounded-2xl shadow-xl bg-white/80 backdrop-blur-sm group relative overflow-hidden"
          >
            <Link to="/chat" onClick={() => trackEvent({ name: 'try_chatbot_cta', props: { location: 'hero' } })}>
              ...
              <MessageSquare className="mr-3 h-6 w-6 relative z-10 transition-transform duration-300 group-hover:translate-x-1" />
